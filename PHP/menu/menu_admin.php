            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
                        <li class="nav-item">
                            <a class="dropdown-item" aria-current="page" href="guardar.php?usuario=<?php echo $usuario; ?>">Ingresar Productos</a>
                        </li>
                        <li class="nav-item">
                            <a class="dropdown-item" aria-current="page" href="listar.php?usuario=<?php echo $usuario; ?>">Listar Productos</a>
                        </li>
                        <li>
                        </li>
                    </ul>
